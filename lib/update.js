 ...
 */
const URL_ABC3 = 'https://www.rossvyaz.ru/upload/gallery/343/33343_0d30059f20824a755839cfb995039cb01a4987e8.csv';
const URL_ABC4 = 'https://www.rossvyaz.ru/upload/gallery/344/33344_4ad38ee167f32a6f62d3eed16c81619ad97e06f2.csv';
const URL_ABC8 = 'https://www.rossvyaz.ru/upload/gallery/345/33345_649114b8792c81010dacd37b1b41444d8c314279.csv';
const URL_DEF  = 'https://www.rossvyaz.ru/upload/gallery/346/33346_6afd95cd41c52dfbc9a4accb63f6f6a17004e559.csv';
...
const SQL = {
    MNP: {
        LOAD_MNP: `
            ...
            IGNORE 1 LINES
            (number, ownerid, mnc, @dummy, regioncode, @portdate, @dummy, @dummy, donorid, @dummy, @dummy, oldmnc, @dummy)
            SET
                portdate = SUBSTRING(@portdate, 1, 19);
        `,
        LOAD_PROVIDER: `
            LOAD DATA LOCAL INFILE :filename
            REPLACE
            ...
            FIELDS TERMINATED BY ','
            IGNORE 1 LINES
            (orgcode, mnc, @dummy, orgname, @dummy);
        `,
        LOAD_REGIONS: `
            LOAD DATA LOCAL INFILE :filename
            REPLACE
    ...
    DEF: {
        LOAD: `
            ...
            FIELDS TERMINATED BY ';'
            IGNORE 1 LINES
            (code, @begin, @end, @dummy, @provider, @region, @dummy, @dummy, @dummy, @dummy)
            SET
 ...
 */
const loadTable = async (conn, sql, filename) => {
    const unlink = util.promisify(fs.unlink);

    await conn.query(sql, {filename});
